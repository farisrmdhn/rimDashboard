	...
	<div class="row">
		<div style="text-align: center;">
	      <div class="col-md-8 col-sm-12 col-xs-12">
	        <div class="x_panel">
	          <div class="x_title">
	            <h2>Create RIM Staff User</h2>
	            <div class="clearfix"></div>
	          </div>
	          <div class="x_content">
	            <br />
            	<form class="form-horizontal form-label-left" action="<?php echo base_url();?>admins/create_rim" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            	<?php echo validation_errors(); ?>
	              ...
	              <div class="form-group">
	                ...
	                <div class="col-md-2 col-sm-2 col-xs-3">
	                  <input type="text" value="@rim" class="form-control col-md-12 col-xs-12" readonly>
	                </div>
	              </div>
	              <div class="form-group">
